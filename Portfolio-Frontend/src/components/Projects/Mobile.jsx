...
function Mobile() {
  ...
  useEffect(() => {
    gsap.fromTo(
      ...
      { opacity: 0, y: 100 },
      { opacity: 1, y: 0, duration: 0.5, delay: 4, ease: "power3.out" }
    );

    gsap.fromTo(
      textRef.current,
      { opacity: 0, x: 100 },
      { opacity: 1, x: 0, duration: 0.5, delay: 4.6, ease: "power3.out" }
    );

    gsap.fromTo(
      buttonRef.current,
      { opacity: 0, y: 100 },
      { opacity: 1, y: 0, duration: 0.5, delay: 5.2, ease: "power3.out" }
    );
  }, []);
