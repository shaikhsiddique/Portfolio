...
function Navbar() {
  ...
  return (
    <div className="w-[89vw] sm:w-[95vw] p-2 sm:mx-10 mx-6 my-5 rounded-full bg-black  text-black flex items-center justify-between select-none z-50 ">
    <div
      className="font-extrabold items-center w-full sm:w-auto text-3xl bg-[#bad3ef] px-5 py-4 rounded-full md:text-5xl leading-8 md:leading-10 font-sans pointer-events-none flex justify-between "
